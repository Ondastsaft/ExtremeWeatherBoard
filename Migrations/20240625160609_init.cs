        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubCategories_AdminUserDatas_CreatorAdminUserDataId",
                        column: x => x.CreatorAdminUserDataId,
                        principalTable: "AdminUserDatas",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentDiscussionThreadId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Comments_DiscussionThreads_ParentDiscussionThreadId",
                        column: x => x.ParentDiscussionThreadId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminLogs_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AdminLogs_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AdminLogs_SubCategories_SubCategoryId",
                        column: x => x.SubCategoryId,
                        principalTable: "SubCategories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminLogs_CategoryId",
                table: "AdminLogs",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AdminLogs_CommentId",
                table: "AdminLogs",
                column: "CommentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminLogs_SubCategoryId",
                table: "AdminLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ParentDiscussionThreadId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubCategories_CreatorAdminUserDataId",
                table: "SubCategories",
                column: "CreatorAdminUserDataId");
